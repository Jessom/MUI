...
function handleEnter(range, context) {
  ...
  this.quill.insertText(range.index, '\n', lineFormats, _quill2.default.sources.USER);	// 插入换行
...
var Toolbar = function (_Module) {
  ...
  _createClass(Toolbar, [{
    ...
    value: function attach(input) {
      ...
      var eventName = input.tagName === 'SELECT' ? 'change' : 'tap';
  ...
  function BaseTheme(quill, options) {
    ...
    var listener = function listener(e) {
      if (!document.body.contains(quill.root)) {
        return document.body.removeEventListener('tap', listener);
      }
    ...
    document.body.addEventListener('tap', listener);
    return _this;
  }
              ...
              if (fileInput.files != null) {
              	for(var i=0; i<fileInput.files.length; i++) {
              		...
              		reader.onload = function (e) {
              			compress(e.target.result, {quality: 0.9,width:640}, function(res) {
              				var range = _this3.quill.getSelection(true);
              				_this3.quill.updateContents(new _quillDelta2.default().retain(range.index).delete(range.length).insert({ image: res }), _emitter2.default.sources.USER);
              				fileInput.value = ""; 
              			});
...
var SnowTooltip = function (_BaseTooltip) {
  ...
  _createClass(SnowTooltip, [{
    ...
    value: function listen() {
      ...
      this.root.querySelector('a.ql-action').addEventListener('tap', function (event) {
      ...
      this.root.querySelector('a.ql-remove').addEventListener('tap', function (event) {
...
var BubbleTooltip = function (_BaseTooltip) {
  ...
  _createClass(BubbleTooltip, [{
    ...
    value: function listen() {
      ...
      this.root.querySelector('.ql-close').addEventListener('tap', function () {
...
module.exports = "<i class='iconfont icon-color mui-btn mui-btn-link toolbtn'></i>";
...
module.exports = "<i class='iconfont icon-h2 mui-btn mui-btn-link toolbtn'></i>";	// 标题

/***/ }),
/* 95 */
/***/ (function(module, exports) {

module.exports = "<i class='iconfont icon-h1 mui-btn mui-btn-link toolbtn'></i>";	//大标题

/***/ }),
/* 96 */
/***/ (function(module, exports) {

module.exports = "<i class='iconfont icon-image'></i>";	// 图片

/***/ }),
/* 97 */
/***/ (function(module, exports) {

module.exports = "<i class='iconfont icon-zuosuojin2'></i>";
...
module.exports = "<i class='iconfont icon-ul mui-btn mui-btn-link toolbtn'></i>";		// 无序列表
...
module.exports = "<i class='iconfont icon-youxuliebiao'></i>";	// 有序列表

/***/ }),
/* 103 */
/***/ (function(module, exports) {

module.exports = "<i class='iconfont icon-hbiaoqian'></i>";
